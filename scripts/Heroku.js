...
rhodvick({
  ...
  if (!isOwner) {
    return reply("*This command is restricted to the bot owner or Rhodvick Xmd owner 💀*");
  }
...
rhodvick({
  ...
  // Check if the command is issued by the owner
  if (!isOwner) {
    return reply("*This command is restricted to the bot owner or Rhodvick owner 💀*");
  }
